...
CREATE INDEX IF NOT EXISTS idx_tournaments_region_id ON tournaments(region_id);
CREATE INDEX IF NOT EXISTS idx_positions_team_id ON positions(team_id);
CREATE INDEX IF NOT EXISTS idx_positions_tournament_id ON positions(tournament_id);
CREATE INDEX IF NOT EXISTS idx_ranking_history_team_id ON ranking_history(team_id);
