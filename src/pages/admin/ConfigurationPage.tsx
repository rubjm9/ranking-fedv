...
const ConfigurationPage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-8 flex gap-3 rounded-lg border border-amber-200 bg-amber-50 dark:bg-amber-950/40 p-4 text-sm text-amber-900 dark:text-amber-300">
        <Info className="h-5 w-5 shrink-0 mt-0.5" />
        <div>
          <p className="font-medium">Solo lectura</p>
          <p className="mt-1 text-amber-800 dark:text-amber-300">
            Los valores mostrados se calculan en tiempo real desde{' '}
            <code className="text-xs bg-amber-100 dark:bg-amber-950/50 px-1 rounded">tournamentUtils.ts</code> y{' '}
            <code className="text-xs bg-amber-100 dark:bg-amber-950/50 px-1 rounded">rankingCalculations.ts</code>.
      ...
      <div className="space-y-8">
        <section>
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="text-sm text-link hover:text-brand-strong font-medium"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <section className="bg-surface rounded-lg shadow-sm border border-line p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              {TEMPORAL_WEIGHT_ROWS.map((row) => (
                ...
                >
                  <p className="text-sm text-content-muted">{row.label}</p>
                  <p className="text-lg font-semibold text-content font-mono">×{row.value}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="bg-surface rounded-lg shadow-sm border border-line p-6">
            ...
            <p className="text-sm text-content-muted mb-4">
              ...
              <code className="text-xs bg-surface-muted px-1 rounded">regional_coefficients</code>.
            </p>
            <div className="grid grid-cols-3 gap-4">
              <div className="rounded-lg border border-line bg-surface-muted px-4 py-3">
                <p className="text-sm text-content-muted">Límite inferior</p>
                <p className="text-lg font-semibold text-content font-mono">
                  {DEFAULT_REGIONAL_CONFIG.floor}
                </p>
              </div>
              <div className="rounded-lg border border-line bg-surface-muted px-4 py-3">
                <p className="text-sm text-content-muted">Límite superior</p>
                <p className="text-lg font-semibold text-content font-mono">
                  {DEFAULT_REGIONAL_CONFIG.ceiling}
                </p>
              </div>
              <div className="rounded-lg border border-line bg-surface-muted px-4 py-3">
                <p className="text-sm text-content-muted">Incremento</p>
                <p className="text-lg font-semibold text-content font-mono">
