...
import { Trophy, Medal, TrendingUp, Users, Calendar, Filter, RefreshCw } from 'lucide-react'
          ...
          {isLoading ? (
            ...
            <div className="divide-y divide-gray-200">
              {rankingData.map((entry: any, index: number) => (
                <div
                  key={entry.team_id}
                  className={`p-6 hover:bg-gray-50 transition-colors ${getPositionColor(entry.ranking_position || index + 1)}`}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      {/* Posición */}
