...
const AboutPage: React.FC = () => {
  return (
    <PageContainer>
      <PageHeader
        title="Sobre el sistema de ranking FEDV"
        subtitle="El sistema oficial de ranking de Ultimate Frisbee en España, diseñado para proporcionar una clasificación justa y transparente de todos los equipos."
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-slate-900 mb-2">Puntos por posición</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-slate-900 mb-2">Coeficiente regional</h3>
            <p className="text-slate-600">
      ...
      {/* Tournament Types */}
      <div className="card">
        <h2 className="text-2xl font-bold text-slate-900 mb-6">Tipos de Torneos</h2>
      ...
      {/* Temporal Weights */}
      <div className="card">
        <h2 className="text-2xl font-bold text-slate-900 mb-6">Ponderación Temporal</h2>
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            <h3 className="text-lg font-semibold text-slate-900 mb-4">Cálculo</h3>
            <p className="text-slate-600 mb-4">
            ...
            <p className="text-slate-600 mt-4">
              Donde <code className="bg-slate-100 px-1 rounded">total_region_points</code> es la suma de 
              puntos CE1 y CE2 de todos los equipos de la región para la temporada.
            </p>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold text-slate-900 mb-4">Parámetros por defecto</h3>
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                <span className="text-slate-600">Increment:</span>
