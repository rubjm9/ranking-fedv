        ...
        footer={
          <>
            ...
            <button
              ...
              className="inline-flex min-h-[44px] items-center justify-center gap-2 rounded-xl bg-orange-700 px-4 py-2 font-medium text-white transition-colors hover:bg-orange-800 disabled:opacity-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500"
            >
