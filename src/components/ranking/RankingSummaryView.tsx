      ...
      {highlightStats && (
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 pt-4 items-stretch">
          <StatsBlock
            ...
            subtitle={`${formatPoints(highlightStats.bestGlobalTeam?.global_points ?? 0, 1)} pts`}
            icon={Trophy}
          ...
          <StatsBlock
            ...
            subtitle={`+${formatPoints(highlightStats.mostPointsGained?.points_gained ?? 0, 1)} pts`}
            icon={BarChart3}
          ...
          <StatsBlock
            ...
            subtitle={
              highlightStats.bestFilial
                ? `${formatPoints(highlightStats.bestFilial.global_points ?? 0, 1)} pts`
                : 'No hay filiales'
            }
            icon={UsersRound}
          ...
          <StatsBlock
            ...
            subtitle={`${formatPoints(highlightStats.bestHistorical?.historical_points ?? 0, 1)} pts`}
            icon={Star}
